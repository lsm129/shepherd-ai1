    ...
    <div>
      ...
      <div style={{ display: 'grid', gap: '24px' }}>
        ...
        <div className="card" style={{ marginTop: '24px' }}>
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', marginBottom: '4px' }}>功能对比</h2>
          <p style={{ color: 'var(--text-secondary)', marginBottom: '20px', fontSize: '14px' }}>查看不同套餐之间的权益差异</p>
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
              <thead>
                <tr style={{ borderBottom: '2px solid #e5e7eb' }}>
                  <th style={{ textAlign: 'left', padding: '10px 12px', fontWeight: '600', color: '#374151', minWidth: '180px' }}>功能</th>
                  <th style={{ textAlign: 'center', padding: '10px 12px', fontWeight: '600', color: currentPlan === 'free' ? '#1e3a5f' : '#6b7280', background: currentPlan === 'free' ? 'rgba(30,58,95,0.04)' : 'transparent' }}>免费版</th>
              ...
              <tbody>
                <tr style={{ background: '#f8fafc' }}><td colSpan={5} style={{ padding: '8px 12px', fontWeight: '700', fontSize: '12px', color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.05em' }}>AI 生成</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>每月AI生成次数</td><td style={{ textAlign: 'center', padding: '8px 12px', fontWeight: '600' }}>10</td><td style={{ textAlign: 'center', padding: '8px 12px', fontWeight: '600' }}>100</td><td style={{ textAlign: 'center', padding: '8px 12px', fontWeight: '600' }}>300</td><td style={{ textAlign: 'center', padding: '8px 12px', fontWeight: '600', color: '#16a34a' }}>无限</td></tr>
                <tr style={{ background: '#f8fafc' }}><td colSpan={5} style={{ padding: '8px 12px', fontWeight: '700', fontSize: '12px', color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.05em' }}>核心功能</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>访客跟进邮件</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>祷告请求管理</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>教会公告生成</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>教会社区页面</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ background: '#f8fafc' }}><td colSpan={5} style={{ padding: '8px 12px', fontWeight: '700', fontSize: '12px', color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Starter 功能</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>讲道社交媒体内容</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>每日灵修生成器</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>教会周报生成</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>模板市场</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ background: '#f8fafc' }}><td colSpan={5} style={{ padding: '8px 12px', fontWeight: '700', fontSize: '12px', color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Pro 功能</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>批量内容工作室</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>AI习惯学习</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>事工健康报告</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>分享模板赚积分</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ background: '#f8fafc' }}><td colSpan={5} style={{ padding: '8px 12px', fontWeight: '700', fontSize: '12px', color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Growth 功能</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>社区知识库</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>全自动AI事工运营</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>白标教会页面</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>专属客户经理</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px', color: '#d1d5db' }}>—</td><td style={{ textAlign: 'center', padding: '8px 12px' }}>✅</td></tr>
                <tr style={{ background: '#f8fafc' }}><td colSpan={5} style={{ padding: '8px 12px', fontWeight: '700', fontSize: '12px', color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.05em' }}>会众席位</td></tr>
                <tr style={{ borderBottom: '1px solid #f3f4f6' }}><td style={{ padding: '8px 12px' }}>会众席位</td><td style={{ textAlign: 'center', padding: '8px 12px', fontWeight: '600' }}>5</td><td style={{ textAlign: 'center', padding: '8px 12px', fontWeight: '600' }}>25</td><td style={{ textAlign: 'center', padding: '8px 12px', fontWeight: '600', color: '#16a34a' }}>无限</td><td style={{ textAlign: 'center', padding: '8px 12px', fontWeight: '600', color: '#16a34a' }}>无限</td></tr>
              </tbody>
            </table>
          </div>
        </div>
