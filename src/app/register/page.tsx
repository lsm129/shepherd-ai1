...
export default function RegisterPage() {
 ...
 <br />We sent a confirmation link to <strong>{email}</strong> ，Please click to activate your account.
 </p>
 ...
 {role === 'pastor' ? 'Next: Church Info →' : 'Next: Join Church →'}
 </button>
 </form>
 ) : step === 2 ? (
 ...
 <div className="form-group">
 <label className="form-label">Church Invitation Code *</label>
 <input
 type="text"
 className="input"
 value={churchCode}
 ...
 placeholder="e.g. SHEP-ABC123"
 required
 />
 {verifyingCode && (
 <div style={{ fontSize: '13px', color: '#6366f1', marginTop: '4px' }}>Verifying...</div>
 )}
 ...
 ✅ Found: <strong>{churchCodeChurch}</strong>
 </div>
 )}
 ...
 ❌ Invalid code. Ask your pastor for the invitation code.
 </div>
 )}
 <div style={{ fontSize: '12px', color: '#999', marginTop: '6px' }}>
 Ask your pastor for the invitation code
 </div>
 </div>
 <div style={{ display: 'flex', gap: '12px', marginTop: '8px' }}>
 <button type="button" className="btn-primary" style={{ flex: 1, background: '#6b7280' }} onClick={() => setStep(1)}>
