...
const advantages = {
 ...
 {
 emoji: '🎯',
 title: 'AI Knows Every Member',
 desc: 'When a congregant joins, our AI analyzes their background, occupation, family, and spiritual needs — then generates a personalized pastoral care plan for the pastor instantly. No other platform does this.',
 },
 ],
 },
};
...
export default function AboutPage() {
 ...
 The story behind ShepherdAI — and the heritage that drives us to serve the global church.
      ...
      <section style={{ padding: '100px 0', background: 'white' }}>
        <div className="page-container" style={{ maxWidth: '800px' }}>
          ...
          <FadeInOnScroll>
            <p style={{ color: '#555', lineHeight: '1.8', textAlign: 'center', maxWidth: '600px', margin: '0 auto 24px' }}>
              ShepherdAI is an independent product that uses <strong>DeepSeek AI (deepseek-chat model)</strong> to power our content generation features. We believe in being fully transparent about the technology that supports your ministry.
            </p>
            <div style={{ background: '#f0f7ff', borderRadius: '12px', padding: '24px', maxWidth: '550px', margin: '0 auto' }}>
              <h3 style={{ fontSize: '16px', fontWeight: 'bold', color: '#1e3a5f', marginBottom: '12px' }}>What DeepSeek AI powers in ShepherdAI:</h3>
              <ul style={{ color: '#555', lineHeight: '2.2', paddingLeft: '24px', margin: 0 }}>
                <li>Sermon and devotional content generation</li>
            ...
            <p style={{ color: '#888', fontSize: '13px', textAlign: 'center', marginTop: '16px' }}>
              ShepherdAI is not affiliated with, endorsed by, or sponsored by DeepSeek AI. <a href="https://www.deepseek.com" style={{ color: '#4a90a4' }}>Learn more about DeepSeek</a>
            </p>
          </FadeInOnScroll>
        </div>
      </section>
 ...
 <h2 style={{ fontSize: '36px', fontWeight: 'bold', color: '#1e3a5f', marginBottom: '16px' }}>
 19 Reasons Pastors Trust ShepherdAI
 </h2>
 ...
 <a href="mailto:support@shepherdaitech.com" style={{
