      ...
      <div style={{ maxWidth: '680px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        {remaining === 1 && !result && (
          <div style={{ marginTop: "12px", padding: "8px 14px", background: "#fef3c7", borderRadius: "8px", fontSize: "13px", color: "#92400e", display: "flex", alignItems: "center", gap: "8px", justifyContent: "center" }}>
            <span>⚠️</span>
            <span>Only <strong>1 free bulletin left</strong> today.{" "}<Link href="/register" style={{ color: "#1e3a5f", fontWeight: "700", textDecoration: "underline" }}>Sign up free</Link> for unlimited bulletins!</span>
          </div>
        )}
          </div>
        </div>
