...
export default function PrivacyPolicy() {
 ...
 <li><strong>AI Content Generation (DeepSeek):</strong> We use DeepSeek AI models (deepseek-chat) to generate content such as sermons, devotionals, prayer responses, newsletters, and pastoral care plans. DeepSeek is a third-party AI service operated by DeepSeek AI. Your input data is sent to DeepSeek servers for processing. For more information, see <a href="https://www.deepseek.com" style={{ color: '#4a90a4' }}>deepseek.com</a></li>
 </ul>
