...
export default function FAQPage() {
 ...
 a: 'ShepherdAI offers a 7-day full-feature free trial, then 20 AI generations per month on the Free plan. Starter is $19/mo for 100 generations. Pro (Team Collaboration) is $39/mo for 300 generations with AI that learns your style. Growth (Full Automation) is $79/mo for unlimited generations and full ministry automation. No credit card required to start.',
 },
 {
