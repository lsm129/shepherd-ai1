...
export default function PrayerRequestsPage() {
 ...
 async function handleRejectResponse(text: string) {
   if (userId) {
     try {
       await fetch('/api/ai-habits', {
         method: 'POST',
         headers: { 'Content-Type': 'application/json' },
         body: JSON.stringify({ userId, action: 'reject', platform: 'prayer-response', originalText: text, toolType: 'prayer-response' }),
       });
