...
export default function DashboardPage() {
    ...
    async function checkAuth() {
      try {
        ...
        try {
          ...
          // Each generation roughly saves ~2.5 hours on average across all agents
  ...
  const features = [
    ...
    },
    {
      ...
      desc: 'Turn one sermon into multiple social media posts',
      color: '#6366f1',
      saves: '3 hrs/week',
    },
    {
      ...
      desc: 'Share your sermon outlines. Browse & use templates from fellow pastors.',
      color: '#22c55e',
      saves: '2 hrs/week',
    },
    {
