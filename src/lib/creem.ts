...
export const CREEM_API_KEY = process.env.CREEM_API_KEY || 'creem_3hVeMbPVSHHFdBS7TN8UJa';
export const CREEM_WEBHOOK_SECRET = process.env.CREEM_WEBHOOK_SECRET || 'whsec_your_webhook_secret';
