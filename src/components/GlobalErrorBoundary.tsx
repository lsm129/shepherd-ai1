 ...
 * Anti-flicker: After 3 rapid errors within 3 seconds, stops auto-recovery 
 * and shows a stable error page instead of flashing.
 */
export default class GlobalErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: any) {
    ...
    // Only auto-retry if not in a rapid error loop
    if (this.errorStreak <= this.maxAutoRetries) {
      this.retryCount++;
          ...
          <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f8fafc' }}>
            <div style={{ background: 'white', borderRadius: '16px', padding: '48px', maxWidth: '480px', width: '90%', boxShadow: '0 4px 24px rgba(0,0,0,0.08)', textAlign: 'center' }}>
              ...
              <p style={{ color: '#666', lineHeight: '1.6', marginBottom: '24px' }}>
                This may be caused by browser translation. Try reloading the page.
              </p>
